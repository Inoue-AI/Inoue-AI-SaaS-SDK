...
class PoolProposeBody(BaseModel):
    """
    PoolProposeBody
    """ # noqa: E501
    members: Optional[List[PoolMemberBody]]
    model_id: StrictStr
    __properties: ClassVar[List[str]] = ["members", "model_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "members": [PoolMemberBody.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None,
