...
class RevenueEventDetail(BaseModel):
    """
    RevenueEventDetail
    """ # noqa: E501
    annotation: RevenueEventAnnotation
    event: RevenueEvent
    __properties: ClassVar[List[str]] = ["annotation", "event"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "annotation": RevenueEventAnnotation.from_dict(obj["annotation"]) if obj.get("annotation") is not None else None,
            "event": RevenueEvent.from_dict(obj["event"]) if obj.get("event") is not None else None
        })
        return _obj
