...
class CollectionItemUpdateBody(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["asset_id", "collection_id", "item_type", "metadata_json", "note_text", "password", "title", "url", "username"]
