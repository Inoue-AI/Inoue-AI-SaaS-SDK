...
class AuthMeResult(BaseModel):
    ...
    AuthMeResult
    """ # noqa: E501
    orgs: Optional[List[AuthMeOrg]]
    private_content_access: StrictBool
    user: UserResponse
    __properties: ClassVar[List[str]] = ["orgs", "private_content_access", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "orgs": [AuthMeOrg.from_dict(_item) for _item in obj["orgs"]] if obj.get("orgs") is not None else None,
            "private_content_access": obj.get("private_content_access"),
