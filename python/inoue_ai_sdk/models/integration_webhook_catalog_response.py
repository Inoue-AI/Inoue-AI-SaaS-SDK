...
class IntegrationWebhookCatalogResponse(BaseModel):
    """
    IntegrationWebhookCatalogResponse
    """ # noqa: E501
    events: Optional[List[EventDescriptor]]
    total: StrictInt
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [EventDescriptor.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None,
            "total": obj.get("total")
        })
        return _obj
