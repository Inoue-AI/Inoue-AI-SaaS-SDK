...
class UserSessionResponse(BaseModel):
    ...
    user_id: StrictStr
    __properties: ClassVar[List[str]] = ["created_at", "device_name", "id", "ip_address", "is_current", "last_activity_at", "last_login_at", "revoked_at", "updated_at", "user_agent", "user_id"]
