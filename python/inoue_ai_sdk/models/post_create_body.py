...
class PostCreateBody(BaseModel):
    ...
    targets: Optional[List[PostTargetCreateBody]] = None
    __properties: ClassVar[List[str]] = ["attachments", "body_text", "model_id", "org_id", "publish_at", "targets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "targets": [PostTargetCreateBody.from_dict(_item) for _item in obj["targets"]] if obj.get("targets") is not None else None
        })
        return _obj
