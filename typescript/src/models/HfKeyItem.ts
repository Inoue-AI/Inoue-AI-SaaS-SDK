...
/**
 * Check if a given object implements the HfKeyItem interface.
 */
export function instanceOfHfKeyItem(value: object): value is HfKeyItem {
...
export function HfKeyItemFromJSON(json: any): HfKeyItem {
    return HfKeyItemFromJSONTyped(json, false);
}

export function HfKeyItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): HfKeyItem {
    if (json == null) {
        return json;
    }
    return {
...
export function HfKeyItemToJSON(json: any): HfKeyItem {
    return HfKeyItemToJSONTyped(json, false);
}

export function HfKeyItemToJSONTyped(value?: HfKeyItem | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
