...
class ModelCandidateResponse(BaseModel):
    ...
    """ # noqa: E501
    body_image_url: StrictStr
    created_at: Optional[datetime]
    face_image_url: StrictStr
    id: StrictStr
    index: StrictInt
    model_id: StrictStr
    provenance: Optional[Any]
    __properties: ClassVar[List[str]] = ["body_image_url", "created_at", "face_image_url", "id", "index", "model_id", "provenance"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "body_image_url": obj.get("body_image_url"),
            "created_at": obj.get("created_at"),
            "face_image_url": obj.get("face_image_url"),
            "id": obj.get("id"),
            "index": obj.get("index"),
