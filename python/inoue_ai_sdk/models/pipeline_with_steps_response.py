...
class PipelineWithStepsResponse(BaseModel):
    """
    PipelineWithStepsResponse
    """ # noqa: E501
    id: StrictStr
    steps: Optional[List[PipelineStepResponse]]
    __properties: ClassVar[List[str]] = ["id", "steps"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "steps": [PipelineStepResponse.from_dict(_item) for _item in obj["steps"]] if obj.get("steps") is not None else None
        })
        return _obj
