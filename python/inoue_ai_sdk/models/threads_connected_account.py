...
class ThreadsConnectedAccount(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["connected_by_user_id", "created_at", "display_name", "handle", "icon_url", "id", "label", "model_count", "model_ids", "owner_org_id", "owner_org_name", "owner_type", "owner_user_id", "ownership", "platform", "status", "updated_at"]
