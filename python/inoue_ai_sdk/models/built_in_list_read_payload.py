...
class BuiltInListReadPayload(BaseModel):
    """
    BuiltInListReadPayload
    """ # noqa: E501
    items: Optional[List[CaptionTemplateResponse]]
    total: StrictInt
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [CaptionTemplateResponse.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total")
        })
        return _obj
