...
class CreatedWebhookResponse(BaseModel):
    """
    ...
    secret_hint: Optional[StrictStr] = None
    updated_at: Optional[datetime]
    url: StrictStr
    __properties: ClassVar[List[str]] = ["created_at", "created_by_user_id", "event_types", "has_secret", "id", "is_enabled", "name", "org_id", "owner_user_id", "scope", "secret", "secret_hint", "updated_at", "url"]
