...
class PoolView(BaseModel):
    ...
    PoolView
    """ # noqa: E501
    members: Optional[List[PoolMember]]
    model_id: StrictStr
    pool: Pool
    __properties: ClassVar[List[str]] = ["members", "model_id", "pool"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "members": [PoolMember.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None,
            "model_id": obj.get("model_id"),
            "pool": Pool.from_dict(obj["pool"]) if obj.get("pool") is not None else None
        })
        return _obj
