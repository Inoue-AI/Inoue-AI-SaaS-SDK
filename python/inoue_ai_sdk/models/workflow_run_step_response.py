...
class WorkflowRunStepResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "engine_slug", "error", "finished_at", "id", "inputs", "job_id", "job_type", "node_id", "node_label", "output_asset_ids", "outputs", "started_at", "status", "workflow_run_id"]
